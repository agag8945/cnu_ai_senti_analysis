...
for num in range(1, 3):
    ...
    # 마지막 페이지 +1의 페이지 URL 가보기! (숙제!!)
    #if title_list ~ 수집이 안되면 :
        #break → 페이지 반복을 멈춰라
    ...
    for i, title in enumerate(title_list):
        ...
        # 1건의 뉴스(제목, 본문) 수집 완료
        news_count += 1             # 'news_count = news_count + 1' 와 같은 코드
